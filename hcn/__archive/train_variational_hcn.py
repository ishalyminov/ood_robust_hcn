...
from modules.variational_hierarchical_lstm import VariationalHierarchicalLSTM
...
class Trainer(object):
    def __init__(self, in_train, in_dev, in_test, in_action_templates, in_random_input, in_post_ood_turns_noisy, in_rev_vocab, in_config, in_model_folder):
        ...
        self.net = VariationalHierarchicalLSTM(in_rev_vocab, self.config, context_features_train.shape[-1], action_masks_train.shape[-1])
...
def configure_argument_parser():
    ...
    result_parser.add_argument('--config', default='hcn_vae_v3.json')

...
from utils.preprocessing import make_dataset_for_variational_hcn, make_vocabulary, PAD_ID, UNK_ID
...
def main(in_clean_dataset_folder, in_noisy_dataset_folder, in_model_folder, in_mode, in_runs_number):
    ...
    net = MaskedDualEncoderVariationalHierarchicalLSTM(rev_vocab, config, context_features_clean.shape[-1], action_masks_clean.shape[-1])

...
from modules.pretrained_de_variational_lstm import PretrainedDEVariationalHierarchicalLSTM
from modules.actions import ActionTracker
from modules.util import read_dialogs, get_utterances, BoW_encoder, load_model
from modules.evaluation import evaluate, evaluate_advanced, mark_post_ood_turns
from utils.preprocessing import make_dataset_for_variational_hcn
...
def main(in_clean_dataset_folder, in_noisy_dataset_folder, in_model_folder, in_mode, in_runs_number):
    ...
    net = PretrainedDEVariationalHierarchicalLSTM(rev_vocab, config, context_features_clean.shape[-1], action_masks_clean.shape[-1], None)

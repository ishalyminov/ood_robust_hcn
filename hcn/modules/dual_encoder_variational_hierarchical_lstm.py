...
class DualEncoderVariationalHierarchicalLSTM(LSTMBase):
    def __init__(self, in_rev_vocab, in_config, in_feature_vector_size, in_action_size):
        self.rev_vocab = in_rev_vocab
        super(DualEncoderVariationalHierarchicalLSTM, self).__init__(in_config, in_feature_vector_size, in_action_size) 

...
class VariationalHierarchicalLSTM(LSTMBase):
    def __init__(self, in_rev_vocab, in_config, in_feature_vector_size, in_action_size):
        ...
        super(VariationalHierarchicalLSTM, self).__init__(in_config, in_feature_vector_size, in_action_size)
    ...
    def __graph__(self):
        ...
        turn_outputs = vrae.decoder_init_state
        turn_features = tf.concat([tf.reshape(turn_outputs, shape=[-1, self.max_input_length, self.config['rnn_size']]), input_contexts], axis=-1)
